...
network.add_neurons(numNeuronsToAdd=N_excit,
	V_init=-70.0, V_thresh=-50.0, V_peak=20.0, V_reset=-70.0, V_eqLeak=-70.0, V_eqExcit=0.0, V_eqInhib=-70.0, slopeFactor=2.0, R_membrane=0.01,
	U_init=0.0, a=0.5, b=7.0,
	g_leak=0.3, g_excit_init=0.0, g_inhib_init=0.0, g_gap=1.0,
	tau_g_excit=2.0, tau_g_inhib=2.0, tau_U=100.0,
...
#~~~~~~~~~~
network.initialize_simulation(T_max=200, deltaT=0.5)
