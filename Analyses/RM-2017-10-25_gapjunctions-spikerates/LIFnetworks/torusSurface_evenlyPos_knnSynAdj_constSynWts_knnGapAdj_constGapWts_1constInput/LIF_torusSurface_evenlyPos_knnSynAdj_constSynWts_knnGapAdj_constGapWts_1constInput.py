...
import seaborn as seaborn
seaborn.heatmap(data=spikeRateAvgOverRepsDataframe, annot=False, cmap='hot', ax=ax_avgRateHeatmap, yticklabels=int(len(c_vals)/2)-1, xticklabels=(True if len(k_vals)<10 else int(len(k_vals)/2)-1) )
