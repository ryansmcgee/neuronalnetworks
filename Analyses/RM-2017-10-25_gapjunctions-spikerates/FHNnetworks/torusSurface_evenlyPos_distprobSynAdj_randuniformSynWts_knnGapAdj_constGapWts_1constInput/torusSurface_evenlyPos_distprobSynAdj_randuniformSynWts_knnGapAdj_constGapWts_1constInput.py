...
experimentDataframe.to_csv('FHN_torusSurface_evenlyPos_distprobSynAdj_randuniformSynWts_knnGapAdj_constGapWts_1constInput_Tmax'+str(representativeNetwork.T_max)+'_'+str(numReps)+'reps_RESULTS.csv', index=False)
...
pyplot.savefig('FHN_torusSurface_evenlyPos_distprobSynAdj_randuniformSynWts_knnGapAdj_constGapWts_1constInput_Tmax'+str(representativeNetwork.T_max)+'_'+str(numReps)+'reps_RESULTS.png', bbox_inches='tight')
