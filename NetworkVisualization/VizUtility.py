...
def shifted_color_map(orig_cmap, start=0, midpoint=0.5, stop=1.0, name='shiftedcmap'):
    '''
...
def zero_midpoint_cmap(orig_cmap, min_val=0.0, max_val=1.0, name='zero-midpt-cmap'):
    ...
    #Ryan edit: to avoid division by 0 below when all values in matrix are 0:
    # - just make the min and max arbitrarily symmetric so the midpoint is 0 is mapped to the center of the colormap (e.g., white)
