...
def rate_network_diagram_3d(ax, network, connectivityMatrix=None, basisT=1000, dark=False, showAxes=False):
	...
	ax.scatter(xs=neuronCoords[neuronIDs_inputInhib,0], ys=neuronCoords[neuronIDs_inputInhib,1], zs=neuronCoords[neuronIDs_inputInhib,2], marker='^', c=rate_cmap(neuronRateCmapping[neuronIDs_inputInhib]), edgecolors=outlineColor, linewidths=1, s=1.7*(pyplot.rcParams['lines.markersize']**2), zorder=4, depthshade=True)
